...
#        cv2.rectangle(frame, (xA, yA), (xB, yB), (0, 255, 0), 2)
    ...
    for i in range(AnswerB.shape[0]) :
        if frame_num == AnswerB[i,0]:
            cv2.rectangle(frame, (AnswerB[i,1],AnswerB[i,2]), (AnswerB[i,3], AnswerB[i,4]), (0, 255, 255), 2)
            index_B = index_B +1;
        elif frame_num != AnswerB[i,0] and index_B !=0:
            cv2.rectangle(frame,(AnswerB[index_B-1,1],AnswerB[index_B-1,2]), (AnswerB[index_B-1,3], AnswerB[index_B-1,4]), (0, 255, 255), 2)            
