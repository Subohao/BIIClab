...
ap.add_argument("-v", "--video",default="D://senior/CCL/video/April30/April30_2sentence3.mpg", help="Path to the file")
ap.add_argument("-f", "--features", default='D://senior/CCL/special_topic/April30_2sentence3.mpg_out_features.npy', help="Path to the file")
